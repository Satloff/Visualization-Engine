...
print "Eigenvalues:"
print pcad.getEigenvalues()

print "\nEigenvectors:"
print pcad.getEigenvectors()

print "\nMeans:"
print pcad.getDataMeans()

print "\nOriginal Headers:"
print pcad.getDataHeaders()

# Test old functions
print "\nProjected data:"
#print pcad.getRowNum(0)
print pcad.getDataNum( pcad.getHeaderRaw() )

print "\nRaw headers:"
print pcad.getHeaderRaw()

print "\nRaw types:"
print pcad.getTypesRaw()

print "\nNumber of rows:"
print pcad.getNumRowRaw()
